...
INSERT INTO filter_conditions (id, filter_id, condition_type, condition_details) VALUES
    ('f0g1h2i3-j4k5-l6m7-n8o9-p0q1r2s3t4u5', 'b3035773-0d5b-4c07-8e6c-7e50b1c9c7f9', 'date', '{"operator": "after", "value": "2024-01-01"}');
...
INSERT INTO filter_conditions (id, filter_id, condition_type, condition_details) VALUES
    ('c3d4e5f6-g7h8-9i0j-k1l2-m3n4o5p6q7r8', 'e842f1f0-a1c2-4a7b-8d6e-9f0a1b2c3d4e', 'date', '{"operator": "before", "value": "2023-12-31"}');
